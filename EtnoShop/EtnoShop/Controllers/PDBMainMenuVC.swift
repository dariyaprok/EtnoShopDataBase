...
class PDBMainMenuVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let viewControllers: [(storyboardName:String, vcId:String)] = [("Arrival", PDBArrivalListVC.identifier), ("Sales", PDBSalesListVC.identifier), ("Money", PDBMoneyVC.identifier), ("Employees", "PDBEmployeesListVC"), ("AdditionalSettings","AdditionalSettingsVC")]
